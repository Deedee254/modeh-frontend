...
// Ensure Echo types are available globally or locally
declare global {
    interface Window {
        Echo: any;
        Pusher: any;
...
export const useNotificationsStore = defineStore('notifications', () => {
    ...
    function markReadLocal(id: string | number) {
        const n = items.value.find(x => x.id === id)
        if (n) n.read = true
    }

    function prependNotification(n: any) {
    ...
    async function fetchNotifications() {
        try {
            ...
            if (res.ok) {
                ...
                items.value = (json.notifications || []) as NotificationItem[]
            }
        } catch (e) {
    ...
    function attachEchoListeners() {
        ...
        try {
            ...
            _echoChannel.listen('.Illuminate\\Notifications.Events.BroadcastNotificationCreated', (payload: any) => {
            ...
            _echoChannel.listen('MessageSent', (payload: any) => {
            ...
            _echoChannel.listen('.BadgeAwarded', (payload: any) => {
            ...
            _echoChannel.listen('.DailyChallengeCompleted', (payload: any) => {
            ...
            _echoChannel.listen('.BattleResult', (payload: any) => {
