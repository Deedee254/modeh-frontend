      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-8">
          <div v-if="!auth.user" class="bg-blue-50 border border-blue-200 rounded-lg p-6">
            ...
            <p class="text-blue-800 mb-4">Create an account or sign in to join this institution and connect with other educators and learners.</p>
          ...
          <div v-else class="bg-yellow-50 border border-yellow-200 rounded-lg p-6">
            ...
            <p class="text-yellow-800 mb-4">Link your profile to this institution to connect with the community of educators and learners.</p>
...
const isUserMember = computed(() => {
  ...
  const userProfileInst = user.role === 'quiz-master'
