<template>
  <div class="p-6">
    <h1 class="text-2xl font-semibold mb-6">Institution Analytics</h1>
    ...
    <div v-else>
                ...
                <div class="flex items-center space-x-2">
                  <div class="w-20 bg-gray-200 rounded-full h-2">
                    <div
                      ...
                      :style="{ width: `${Math.min((range.count / Math.max(...(performanceData?.score_distribution?.map(r => r.count) || [1]))) * 100, 100)}%` }"
                    ></div>
                  </div>
      ...
      <div v-if="overview?.subscription" class="mt-6 bg-white rounded-lg shadow border p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <div class="text-center">
            <div class="text-2xl font-bold text-blue-600">{{ overview.subscription.seats_available }}</div>
