        ...
        <div class="flex flex-col space-y-4">
          <button 
            ...
            :class="[
              ...
              formData.role === 'student' ? 'border-blue-500 bg-blue-50' : 'border-gray-200 hover:border-blue-200'
            ]"
          >
            ...
            <div class="text-left">
              <div class="font-medium">I am a Student</div>
          ...
          <button 
            ...
            :class="[
              'px-6 py-4 border-2 rounded-lg flex items-center space-x-3',
              formData.role === 'tutor' ? 'border-blue-500 bg-blue-50' : 'border-gray-200 hover:border-blue-200'
            ]"
          >
            <svg class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div class="text-left">
              <div class="font-medium">I am a Tutor</div>
...
const steps = [
  ...
  { key: 'role', label: 'Role' },
  { key: 'grade', label: 'Grade', condition: () => formData.role === 'student' },
  { key: 'subjects', label: 'Subjects', condition: () => formData.role === 'tutor' },
]
...
const canProceed = computed(() => {
  switch (currentStep.value) {
    ...
    case 'grade':
      return formData.value.role !== 'student' || !!formData.value.grade
    case 'subjects':
      return formData.value.role !== 'tutor' || formData.value.subjects.length > 0
    default:
      return false
  }
})
