<template>
  <div class="bg-gray-50 min-h-screen">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
      <NuxtLink to="/quizee/institutions" class="inline-flex items-center gap-1 text-brand-600 hover:text-brand-700 font-medium text-sm">
    ...
    <div v-else-if="error" class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div class="text-center">
        ...
        <NuxtLink to="/quizee/institutions" class="inline-block px-6 py-2 bg-brand-600 text-white rounded-lg hover:bg-brand-700">
          Back to Institutions
        </NuxtLink>
      </div>
    </div>
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-8">
          <div v-if="!auth.user" class="bg-blue-50 border border-blue-200 rounded-lg p-6">
            ...
            <p class="text-blue-800 mb-4">Create an account or sign in to join this institution and connect with Quiz Masters and Quizees.</p>
            <div class="flex gap-3">
              <NuxtLink to="/login" class="px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 font-medium">
                Sign In
              </NuxtLink>
              <NuxtLink to="/register/quizee" class="px-6 py-2 bg-white text-blue-600 border border-blue-200 rounded-lg hover:bg-blue-50 font-medium">
                Create Account
              </NuxtLink>
            </div>
          </div>
          ...
          <div v-else class="bg-yellow-50 border border-yellow-200 rounded-lg p-6">
            ...
            <p class="text-yellow-800 mb-4">Link your profile to this institution to connect with its community of Quiz Masters and Quizees.</p>
          ...
          <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <div v-else class="space-y-3">
              ...
              <NuxtLink
                ...
                :to="{ path: '/quizee/institutions', query: { view: 'members', slug: institution.slug } }"
...
useHead({
  ...
  meta: [
    { name: 'description', content: 'View institution details and join to connect with its community.' }
  ]
})
