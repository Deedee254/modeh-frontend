      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-8">
          <div v-if="!auth.user" class="bg-blue-50 border border-blue-200 rounded-lg p-6">
            ...
            <p class="text-blue-800 mb-4">Create an account or sign in to join this institution and connect with educators and learners.</p>
            <div class="flex gap-3">
              <NuxtLink to="/login" class="px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 font-medium">
                Sign In
              </NuxtLink>
              <NuxtLink to="/register" class="px-6 py-2 bg-white text-blue-600 border border-blue-200 rounded-lg hover:bg-blue-50 font-medium">
                Create Account
              </NuxtLink>
            </div>
          </div>
...
onMounted(() => {
  if (institution.value) {
    useHead({
      ...
      meta: [
        { name: 'description', content: `Join ${institution.value.name} on Modeh to connect with educators and learners.` }
      ]
    })
