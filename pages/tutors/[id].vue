<template>
  <div class="min-h-screen bg-gray-50">
    <div class="container mx-auto p-6 max-w-4xl">
      <div class="my-8">
        <NuxtLink to="/tutors" class="text-indigo-600 hover:underline">
...
function messageTutor() {
  // Open chat widget and start DM with this tutor
  if (typeof window !== 'undefined') {
    // If DirectMessages is a modal or route, navigate or open it with tutor id
    // For this example, redirect to /student/chat?user_id={tutorId}
    router.push({ path: '/student/chat', query: { user_id: tutorId } })
  }
}
</script>
