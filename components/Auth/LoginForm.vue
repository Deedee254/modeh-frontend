    ...
    <div :class="cardClass">
      ...
      <form @submit.prevent="submit" class="space-y-3">
        <div>
          ...
          <input v-model="email" type="email" required placeholder="you@example.com" class="mt-1 block w-full rounded-md border-gray-200 shadow-sm px-3 py-2 focus:border-indigo-500 focus:ring-indigo-500" />
        </div>
        <div>
